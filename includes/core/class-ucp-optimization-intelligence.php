...
class UCP_Optimization_Intelligence {
    ...
    public static function maybe_mark_css_stale_for_option($option, $old_value, $value) {
    ...
    public static function register_rest_routes() {
        ...
        register_rest_route('ultracache-pro/v1', '/diagnostics/url', array(
            ...
            'permission_callback' => array(__CLASS__, 'permissions_check'),
            'args' => array('url' => array('type' => 'string', 'required' => false)),
        ));
    ...
    public static function rest_url_diagnosis($request) {
        ...
        $url = $url ? UCP_Helpers::enforce_local_url($url) : home_url('/');
