...
trait UCP_Log_Package_Download_Trait {
    public static function bootstrap() {
        ...
        add_action('ucp_logs_retention_cleanup', array(__CLASS__, 'cleanup_old_log_files'));
    ...
    public static function build_zip($zip_path) {
        ...
        $legacy = UCP_CACHE_DIR . 'logs/events.log';
        if (is_readable($legacy)) {
            self::add_redacted_text_file($zip, 'file-logs/events.log', $legacy);
        }
