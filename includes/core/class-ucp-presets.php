    ...
    public static function all() {
        return array(
            'pagespeed_auto' => array(
                ...
                'description' => __('Alles-in-één profiel voor Elementor/WooCommerce: cache, Used CSS, Delay JS, lokale fonts, lazyload en veilige checkout-bypasses.', 'ultracache-pro'),
            ...
            'balanced' => array(
                ...
                'overrides' => array(
                    ...
                    'enable_targeted_purge' => 1, 'enable_cache_tags' => 1, 'enable_woocommerce_rules' => 1,
                    'enable_css_minify' => 1, 'enable_js_minify' => 1, 'enable_css_combine' => 0, 'enable_js_combine' => 0,
                    'enable_delay_js' => 0, 'defer_all_js' => 0, 'enable_defer_js_fallback' => 0,
                    'enable_lazy_images' => 0, 'enable_lazy_iframes' => 0, 'css_delivery_mode' => 'none', 'enable_used_css' => 0, 'enable_critical_css' => 0,
                    'enable_remove_query_strings' => 0, 'enable_font_display_swap' => 0, 'enable_cdn' => 0, 'enable_cloudflare_apo_mode' => 0,
                ),
            ...
            'fast' => array(
                ...
                'overrides' => array(
                    'ui_mode' => 'simple', 'enable_cache' => 1, 'enable_preload' => 1, 'enable_css_minify' => 1, 'enable_js_minify' => 1,
            ...
            'aggressive' => array(
                ...
                'overrides' => array(
                    'ui_mode' => 'advanced', 'enable_cache' => 1, 'enable_css_minify' => 1, 'enable_js_minify' => 1, 'enable_lazy_images' => 1, 'enable_lazy_iframes' => 1,
                    'enable_font_display_swap' => 1, 'enable_remove_query_strings' => 1, 'enable_delay_js' => 1, 'delay_js_mode' => 'all', 'delay_js_safe_mode' => 0,
                    'css_delivery_mode' => 'remove_unused', 'enable_used_css' => 1, 'enable_css_queue' => 1, 'enable_critical_css' => 0, 'preload_critical_images' => 1, 'lazyload_exclude_leading_images' => 1,
                ),
            ),
            'woocommerce' => array(
