<?php
// phpcs:disable WordPress.NamingConventions.PrefixAllGlobals -- Existing public UCP preset keys are preserved.
if (!defined('ABSPATH')) {
    exit;
}
 ...
 *
 * This keeps UCP_Presets focused on custom-preset persistence and application.
 */
final class UCP_Preset_Registry {
...
.sticky-header-effects",
    ...
    public static function built_in_presets() {
        return array(
            'pagespeed_auto' => array(
                'label' => __('PageSpeed Auto', 'ultracache-pro'),
                'description' => __('Staging-vriendelijk profiel voor Elementor/WooCommerce: cache, preload, CSS-minify, font-display swap, lazyload en veilige checkout-bypasses. Used CSS en Delay JS blijven bewust handmatig.', 'ultracache-pro'),
            ...
            'safe' => array(
                ...
                'overrides' => array(
                    'ui_mode' => 'simple', 'enable_cache' => 1, 'cache_mobile_separately' => 0,
            ...
            'balanced' => array(
                ...
                'description' => __('Voorspelbare standaard: cache, rustige preload, CSS-minify, WooCommerce-bescherming en veilige media-optimalisatie zonder agressieve JS/CSS-wijzigingen.', 'ultracache-pro'),
                'overrides' => array(
                    'ui_mode' => 'simple', 'enable_cache' => 1, 'cache_mobile_separately' => 0,
                    'enable_preload' => 1, 'enable_preload_queue' => 1, 'preload_homepage' => 1, 'preload_sitemaps' => 1,
                    'browser_cache_headers' => 1, 'enable_remove_emojis' => 1, 'enable_heartbeat_control' => 1, 'enable_prefetch_links' => 0,
                    'enable_targeted_purge' => 1, 'enable_cache_tags' => 1, 'enable_woocommerce_rules' => 1,
            ...
            'fast' => array(
                ...
                'overrides' => array(
                    ...
                    'enable_css_combine' => 0, 'enable_js_combine' => 0, 'enable_lazy_images' => 1, 'enable_lazy_iframes' => 0,
            ...
            'aggressive' => array(
                ...
                'overrides' => array(
                    'ui_mode' => 'advanced', 'enable_cache' => 1, 'enable_css_minify' => 1, 'enable_js_minify' => 0, 'enable_lazy_images' => 1, 'enable_lazy_iframes' => 0,
            ...
            'safe_off' => array(
                ...
                'overrides' => array(
                    ...
                    'enable_css_minify' => 1, 'enable_js_minify' => 0, 'enable_css_combine' => 0, 'enable_js_combine' => 0,
                    'enable_lazy_images' => 0, 'enable_lazy_iframes' => 0, 'enable_prefetch_links' => 0,
