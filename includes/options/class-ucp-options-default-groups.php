<?php
// phpcs:disable WordPress.NamingConventions.PrefixAllGlobals -- Existing public UCP option keys are preserved.
if (!defined('ABSPATH')) {
    exit;
}

/**
 * Central grouped option defaults.
 *
 * Kept outside the lifecycle/defaults trait so the trait remains readable and
 * future defaults can be split by domain without changing UCP_Options::defaults().
 */
final class UCP_Options_Default_Groups {
...
return array(
            ...
            'cache_backend'                   => 'auto',
            'cache_lifespan'                 => 10,
            'enable_cache_policy_rules'       => 0,
            'cache_policy_rules'              => '',
            'enable_cache_insights'           => 1,
            'cache_insights_sample_rate'      => 1,
            'cache_insights_retention_days'   => 7,
            'cache_logged_in'                => 0,
...
borlabs",
            ...
            'enable_html_attribute_quote_removal' => 0,
...
hubspot",
            ...
            'enable_font_unicode_ranges'     => 0,
            'font_unicode_ranges'            => 'latin',
            ...
            // Keep Used/Critical CSS retries calm and predictable. Matches the
            // sanitizer fallback (3) so fresh installs and saved settings agree,
            // and avoids hammering the generator before falling back to normal CSS.
            ...
            'db_cleanup_optimize_all_tables' => 0,
            ...
            'enable_image_cdn'               => 0,
            'enable_image_cdn_transforms'    => 0,
            'enable_adaptive_image_srcset'   => 0,
            'image_cdn_base'                 => '',
            'image_cdn_query'                => '',
            'image_cdn_transform_provider'   => 'auto',
            ...
            'enable_rum'                     => 0,
            'rum_sample_rate'                => 10,
            'cwv_timeseries_retention_days'  => 7,
