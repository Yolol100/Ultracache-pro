...
trait UCP_Options_Defaults_Trait {
    ...
    protected static function rocket_style_default_overrides() {
        ...
        $keys = array(
            ...
            'enable_css_minify', 'enable_js_minify', 'enable_css_combine', 'enable_js_combine', 'enable_delay_js',
            ...
            'enable_light_preload_requests', 'preload_content_scope', 'cache_refresh_interval', 'enable_lazy_render',
