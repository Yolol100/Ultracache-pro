...
final class UCP_Loader {
    ...
    /**
     * Return known runtime files for diagnostics/backward compatibility.
     *
     * This list is derived from the lazy class/trait map so the loader has a single
     * source of truth. Compatibility wrapper files are appended separately and are
     * not eagerly required by the plugin runtime.
     *
     * @return array<int,string>
     */
    public static function files() {
        return array_values(array_unique(array_merge(
            array_values(self::classmap()),
            self::compatibility_files()
        )));
    }

    /**
     * Return legacy wrapper files kept for external/backward-compatible includes.
     *
     * The autoloader targets canonical implementation files directly. These wrapper
     * paths remain packaged so older snippets or support tooling that include the
     * historic locations do not break during a minor update.
     *
     * @return array<int,string>
     */
    private static function compatibility_files() {
        return array(
            'includes/class-ucp-assets.php',
            'includes/class-ucp-cache-tags.php',
            'includes/class-ucp-cache.php',
            'includes/class-ucp-cloud.php',
            'includes/class-ucp-compat.php',
            'includes/class-ucp-css.php',
            'includes/class-ucp-db-cleanup.php',
            'includes/class-ucp-diagnostics.php',
            ...
            'includes/core/class-ucp-log-package.php',
            'includes/rest/class-ucp-rest-admin-controller.php',
        );
    }
     ...
     *
     * Old wrapper files remain in the package for backward compatibility, but the loader now
     * targets canonical implementation files directly. This keeps frontend requests leaner and
     * prevents loading dozens of admin-only files when they are not needed.
     *
    ...
    private static function classmap() {
        return array(
            ...
            'ucp_cloud_css_trait' => 'includes/cloud/class-ucp-cloud.php',
            'ucp_cloud_endpoint_trait' => 'includes/cloud/class-ucp-cloud.php',
            'ucp_cloud_http_trait' => 'includes/cloud/class-ucp-cloud.php',
            'ucp_cloud_routes_trait' => 'includes/cloud/class-ucp-cloud.php',
