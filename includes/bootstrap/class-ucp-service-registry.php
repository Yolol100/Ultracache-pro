...
final class UCP_Service_Registry {
    ...
    public static function runtime_modules() {
        return apply_filters('ucp_runtime_service_definitions', array(
            array('class' => 'UCP_Compat_Profiles', 'mode' => 'always'),
            ...
            array('class' => 'UCP_Image_Optimizer', 'mode' => 'backend_or_any', 'keys' => array('enable_webp_generation', 'enable_avif_generation', 'enable_image_cdn')),
