 ...
 *
 * Keep this file as the single place for class/trait-to-file mappings. The
 * loader reads this manifest lazily so the loader class stays small while
 * preserving the previous lightweight autoload behaviour.
 *
