...
class UCP_Admin_Sanitizer {
    ...
    public static function sanitize($input) {
        ...
        $checkbox_fields = array(
            'enable_cache', 'cache_logged_in', 'cache_mobile_separately', 'cache_query_strings', 'enable_stale_cache', 'enable_woocommerce_rules',
            'enable_preload', 'preload_homepage', 'preload_sitemaps', 'enable_html_minify', 'enable_html_test_mode', 'remove_html_comments',
            'enable_css_minify', 'enable_css_combine', 'enable_js_minify', 'enable_js_combine', 'enable_delay_js', 'delay_js_safe_mode', 'delay_js_disable_click_delay',
            ...
            'enable_critical_css', 'enable_css_queue', 'enable_remote_css_render', 'css_artifact_rollback', 'enable_cdn', 'browser_cache_headers',
            ...
            'enable_cloudflare_apo_mode', 'enable_early_hints_links', 'enable_admin_bar', 'enable_asset_test_mode', 'purge_on_post_update', 'purge_on_comment',
            'purge_on_theme_switch', 'enable_cache_tags', 'enable_object_cache_support', 'enable_diagnostics', 'enable_logs', 'enable_health_checks', 'autopilot_enabled', 'onboarding_completed',
            'allow_wp_config_write', 'allow_dropin_writes', 'enable_preload_queue', 'enable_targeted_purge', 'enable_light_preload_requests', 'enable_lazy_render', 'enable_disable_dashicons', 'enable_disable_jquery_migrate', 'enable_move_module_scripts_footer', 'safe_settings_export', 'enable_disable_xmlrpc', 'enable_hide_wp_version', 'enable_remove_rsd_link', 'enable_remove_shortlink', 'enable_disable_rss_feeds', 'enable_remove_rss_feed_links', 'enable_disable_self_pingbacks', 'enable_disable_rest_api', 'enable_remove_rest_api_links', 'enable_disable_google_maps', 'enable_disable_password_strength_meter', 'allow_dropin_takeover', 'enable_disable_comments', 'enable_remove_comment_links', 'enable_blank_favicon', 'enable_remove_global_styles', 'enable_separate_block_styles', 'enable_disable_google_fonts', 'enable_hide_toolbar_menu', 'enable_lazyload_fade_in', 'enable_lazyload_background_images'
        );
        ...
        $textarea_modes = array(
            ...
            'cache_query_string_inclusions' => 'key',
        ...
        $text_fields = array(
            'ui_mode', 'active_preset', 'css_delivery_mode', 'delay_js_mode', 'speculation_mode', 'speculation_eagerness', 'cache_refresh_interval', 'db_cleanup_frequency', 'preload_content_scope', 'cloud_endpoint', 'cloud_api_key', 'cloud_site_id',
            'cloudflare_zone_id', 'cloudflare_api_token', 'onboarding_site_type', 'onboarding_goal', 'delay_js_presets', 'cdn_file_types', 'heartbeat_frontend_behavior', 'heartbeat_editor_behavior', 'heartbeat_backend_behavior'
        );
