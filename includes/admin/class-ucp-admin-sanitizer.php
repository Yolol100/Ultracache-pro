...
class UCP_Admin_Sanitizer {
    ...
    public static function sanitize($input) {
        ...
        $number_fields = array(
            ...
            'preload_batch_size', 'preload_max_urls', 'image_quality', 'fragment_cache_ttl', 'rest_cache_ttl', 'autosave_interval', 'lazyload_threshold', 'resource_hints_preconnect_limit', 'resource_hints_dns_limit'
        );
