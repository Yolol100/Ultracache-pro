...
final class UCP_Admin_Fields {
    ...
    public static function checkbox($key, $label, $settings, $help = '') {
        ...
        ?>
        <label class="ucp-field ucp-field--checkbox ucp-checkbox<?php echo !empty($args['disabled']) ? ' is-disabled' : ''; ?>"<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- generated by wrapper_attrs() with esc_attr().
            echo $wrapper_attrs; ?>>
    ...
    public static function text($key, $label, $settings, $help = '') {
        ...
        $disabled_attr = !empty($args['disabled']) ? ' disabled' : '';
        ?>
        <label class="ucp-field ucp-field--text<?php echo !empty($args['disabled']) ? ' is-disabled' : ''; ?>"<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- generated by wrapper_attrs() with esc_attr().
            echo $wrapper_attrs; ?>>
            <span><?php echo esc_html($label); ?></span>
            <input type="text" data-ucp-control="1" data-ucp-primary-control="1" name="<?php echo esc_attr(UCP_Options::OPTION_KEY); ?>[<?php echo esc_attr($key); ?>]" value="<?php echo esc_attr(isset($settings[$key]) ? $settings[$key] : ''); ?>" aria-label="<?php echo esc_attr($label); ?>"<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static disabled attribute.
            echo $disabled_attr; ?>>
    ...
    public static function number($key, $label, $settings, $min = 0, $max = 999999, $help = '') {
        ...
        $disabled_attr = !empty($args['disabled']) ? ' disabled' : '';
        ?>
        <label class="ucp-field ucp-field--number<?php echo !empty($args['disabled']) ? ' is-disabled' : ''; ?>"<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- generated by wrapper_attrs() with esc_attr().
            echo $wrapper_attrs; ?>>
            <span><?php echo esc_html($label); ?></span>
    ...
    public static function textarea($key, $label, $settings, $help = '') {
        ...
        $disabled_attr = !empty($args['disabled']) ? ' disabled' : '';
        ?>
        <label class="ucp-field ucp-field--textarea<?php echo !empty($args['disabled']) ? ' is-disabled' : ''; ?>"<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- generated by wrapper_attrs() with esc_attr().
            echo $wrapper_attrs; ?>>
            <span><?php echo esc_html($label); ?></span>
    ...
    public static function select($key, $label, $settings, $options, $help = '') {
        ...
        $disabled_attr = !empty($args['disabled']) ? ' disabled' : '';
        ?>
        <label class="ucp-field ucp-field--select<?php echo !empty($args['disabled']) ? ' is-disabled' : ''; ?>"<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- generated by wrapper_attrs() with esc_attr().
            echo $wrapper_attrs; ?>>
            <span><?php echo esc_html($label); ?></span>
