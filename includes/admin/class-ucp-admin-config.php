...
class UCP_Admin_Config {
    ...
    public static function tabs() {
        return array(
            ...
            'advanced_rules' => array('label' => __('Regels', 'ultracache-pro'), 'icon' => 'dashicons-editor-ul', 'meta' => __('Uitsluitingen, query strings, purge en CDN-basis', 'ultracache-pro')),
    ...
    public static function tab_meta($tab) {
        ...
        $map = array(
            ...
            'advanced_rules' => array('title' => __('Regels', 'ultracache-pro'), 'description' => __('Uitsluitingen, cookies, query strings, purge-regels en CDN-basis.', 'ultracache-pro'), 'focus' => __('Uitzonderingen en regels', 'ultracache-pro')),
