...
class UCP_Admin_Metrics {
    ...
    public static function current_onboarding_step() {
        $step = /* phpcs:ignore WordPress.Security.NonceVerification.Recommended -- read-only admin routing/filter parameter. */ isset($_GET['setup_step']) ? absint(wp_unslash($_GET['setup_step'])) : 0;
