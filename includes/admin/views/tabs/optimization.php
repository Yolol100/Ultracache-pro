...
?>
        ...
        <section class="ucp-optimization-column ucp-panel--optimization ucp-panel--optimization-css ucp-panel--optimization-top ucp-panel--optimization-balance">
            ...
            <div class="ucp-wpr-options-list">
                <?php $admin->checkbox('enable_css_minify', __('CSS verkleinen', 'ultracache-pro'), $settings, __('Veilig voor de meeste sites.', 'ultracache-pro')); ?>
                <div class="ucp-callout ucp-callout--info ucp-callout--compact"><strong><?php esc_html_e('CSS-levering optimaliseren', 'ultracache-pro'); ?></strong><p><?php esc_html_e('Elimineert render-blocking CSS. Er kan maar één methode actief zijn. Ongebruikte CSS verwijderen is aanbevolen voor de beste prestaties; CSS asynchroon laden is de veilige fallback als layout breekt.', 'ultracache-pro'); ?></p></div>
                <?php $admin->select('css_delivery_mode', __('CSS-levering optimaliseren', 'ultracache-pro'), $settings, array('none' => __('Uit', 'ultracache-pro'), 'remove_unused' => __('Ongebruikte CSS verwijderen - aanbevolen', 'ultracache-pro'), 'async' => __('CSS asynchroon laden', 'ultracache-pro')), __('Kies één methode. Test grondig op staging, vooral met Elementor, sticky headers, sliders en WooCommerce.', 'ultracache-pro')); ?>
            </div>
        ...
        <section class="ucp-panel full ucp-panel--optimization-js ucp-panel--optimization-js-live">
            ...
            <div class="ucp-wpr-options-list">
                <?php $admin->checkbox('enable_js_minify', __('JavaScript verkleinen', 'ultracache-pro'), $settings, __('Veilig voor de meeste sites.', 'ultracache-pro')); ?>
