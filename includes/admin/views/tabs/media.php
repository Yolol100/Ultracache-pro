        ...
        <section class="ucp-panel full ucp-panel--media-main ucp-media-combined-card">
            ...
            <div class="ucp-media-main-grid">
                ...
                <div class="ucp-media-column">
                    ...
                    <div class="ucp-wpr-options-list">
                        <?php $admin->checkbox('enable_image_optimization', __('Nieuwe uploads automatisch optimaliseren', 'ultracache-pro'), $settings, __('Nieuwe uploads krijgen automatisch moderne varianten als de server dit ondersteunt.', 'ultracache-pro')); ?>
                        <?php $admin->checkbox('enable_webp_generation', __('WebP-varianten maken', 'ultracache-pro'), $settings, __('Veilige premium basis voor moderne browsers.', 'ultracache-pro')); ?>
                        <?php $admin->checkbox('enable_avif_generation', __('AVIF-varianten maken', 'ultracache-pro'), $settings, __('Alleen gebruiken als je hosting AVIF goed ondersteunt.', 'ultracache-pro')); ?>
